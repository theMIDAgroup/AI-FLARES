...
;
; CALLING SEQUENCE:
;   int_extr_routine, vis, trigger_map
;
; INPUTS:
...
;   trigger_map: the map of the previous energy channel
;
; OUTPUTS:
...
;   Oct-2024, Volpara A adapted the code to RIS approach

pro int_extr_routine, vis, trigger_map, imsize=imsize, pixel=pixel, $
...
;;;;;;;;;;;;;;;;; Plot of the visibility sampling on the (u,v)-plane ;;;;;;;;;;;;;;;;;
  ...
  visnew = int_vsk(vis, trigger_map, usampl, N, Ulimit, ep, aux_data, imsize)
