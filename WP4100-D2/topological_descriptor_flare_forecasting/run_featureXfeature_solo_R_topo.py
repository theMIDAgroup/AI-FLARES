...
if __name__ == '__main__':
    ...
    for it_class in flare_class:
        for it_issuing in issuing:
            ...
            folder_res = folder_bootstrap + '/results_R/results_' + it_class + '_' + properties
            AR_list = np.loadtxt('data/AR_list_' + properties + '_' + start_time + '_' + end_time + '.txt')
            label = 'flaring'
            n_AR = len(AR_list)
            for algorithm in algorithm_list:
                file_df_fulldata = folder_res + '/feature_importance_' +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + 'r_value_blos_logr.pkl'
                file_ranking_fulldata = folder_res + '/ranking_'+it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + 'r_value_blos_logr.pkl'
                file_df_predict_fulldata = folder_res + '/skill_scores_testing_' +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + 'r_value_blos_logr.pkl'

                file_df_fulldata_csv = folder_res + '/feature_importance_' +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + 'r_value_blos_logr.csv'
                file_ranking_fulldata_csv = folder_res + '/ranking_'  +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + 'r_value_blos_logr.csv'
                file_df_predict_fulldata_csv = folder_res + '/skill_scores_testing_'  +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + 'r_value_blos_logr.csv'
                ...
                for it_run in np.arange(n_run):
                    ...
                    if topo == 1:
                        df_X_training = df_X_training[['r_value_blos_logr']]
                        df_X_testing = df_X_testing[['r_value_blos_logr']]
