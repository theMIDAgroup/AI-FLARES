...
if __name__ == '__main__':
    ...
    for it_class in flare_class:
        for it_issuing in issuing:
            ...
            folder_res = folder_bootstrap + '/fXf_noDR_results_' + it_class + '_' + properties
            ...
            for algorithm in algorithm_list:
                ...
                for it_run in np.arange(n_run):
                    ...
                    file_df_fulldata = folder_res + '/fXf_noDR_feature_importance_' + it_class + '_' + properties + '_' + start_time + '_' + end_time +'_' + str(it_run) + '_' + algorithm + '.pkl'
                    file_df_predict_fulldata = folder_res + '/fXf_noDR_skill_scores_testing_' + it_class + '_' + properties + '_' + start_time + '_' + end_time +'_' + str(it_run) +'_' + algorithm + '.pkl'

                    file_df_fulldata_csv = folder_res + '/fXf_noDR_feature_importance_' + it_class + '_' + properties + '_' + start_time + '_' + end_time + '_'+ str(it_run) +  '_' + algorithm + '.csv'
                    file_df_predict_fulldata_csv = folder_res + '/fXf_noDR_skill_scores_testing_' + it_class + '_' + properties + '_' + start_time + '_' + end_time +'_' + str(it_run) + '_' + algorithm + '.csv'
                    ...
                    for it_f in np.arange(n_feature):
                        ...
                        indici_aux = indici_features_full[it_init:it_init + it_f + 1]
