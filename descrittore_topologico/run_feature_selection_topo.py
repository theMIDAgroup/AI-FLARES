...
if __name__ == '__main__':
    ...
    algorithm_list =('HybridLogit',)# ('RandomForest','HybridLasso', )#('RandomForest','HybridLasso', 'HybridLogit', )#('SVC-CV',)# 'SVC-CV',('HybridLasso', 'HybridLogit', 'RandomForest')
    algo_str_list = ('HybridLogit',)#('RandomForest','HybridLasso', )#('RandomForest','HybridLasso', 'HybridLogit', )#('SVC-CV',)#  ,'SVC'('HybridLasso', 'HybridLogit', 'RandomForest')
    ...
    for it_class in flare_class:
        for it_issuing in issuing:
            ...
            folder_res = folder_bootstrap + '/results_' + it_class + '_' + properties
            AR_list = np.loadtxt('data/AR_list_' + properties + '_' + start_time + '_' + end_time + '.txt')
            label = 'flaring'
            n_AR = len(AR_list)
            for algorithm in algorithm_list:
                file_df_fulldata = folder_res + '/feature_importance_' +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + '.pkl'
                file_ranking_fulldata = folder_res + '/ranking_'+it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + '.pkl'
                file_df_predict_fulldata = folder_res + '/skill_scores_testing_' +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + '.pkl'

                file_df_fulldata_csv = folder_res + '/feature_importance_' +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + '.csv'
                file_ranking_fulldata_csv = folder_res + '/ranking_'  +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + '.csv'
                file_df_predict_fulldata_csv = folder_res + '/skill_scores_testing_'  +it_class+ '_'+properties +'_'+start_time+'_'+end_time+'_'+algorithm + '.csv'
